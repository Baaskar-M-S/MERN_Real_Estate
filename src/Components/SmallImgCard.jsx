...
const SmallImgCard = () => {
  return (
    <div className="flex w-[270px] h-[310px] flex-col items-start p-4 shadow-md border ">
      <img className="object-cover h-[180px] w-full rounded-md mb-4" src="https://www.chennaiproperties.in/property/20046/gallery/693-Sqft-2-BHK-House-for-sale-in-Guduvanchery-20046-1.jpeg" alt="property image"/>
